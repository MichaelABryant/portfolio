...
- Predictive model is implemented with a front end as a [web app](https://predict-vehicle-price.herokuapp.com/) which can be used suggest a sales price to the user
